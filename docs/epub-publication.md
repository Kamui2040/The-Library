...
The builder targets conservative reflowable EPUB 3.3 packaging with:
...
- EPUB navigation derived from the canonical book manifest, with an NCX compatibility fallback for older readers;
...
The stylesheet uses ordinary block layout and responsive images only. It does not use viewport-height sizing, flex-based page simulation, forced physical page geometry, or pseudo-page breaks. Reading systems remain responsible for viewport fitting and pagination.
